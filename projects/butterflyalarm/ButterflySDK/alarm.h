...
/** @file alarm.h Alarm module header file. */

#ifndef __ALARM_HEADER__
#define __ALARM_HEADER__

extern void AlarmInit(void);
extern BOOL AlarmIsOn(void);
extern void AlarmStop(void);
extern void AlarmCompareTask(void);


#endif // __ALARM_HEADER__
