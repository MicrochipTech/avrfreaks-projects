...
/** @file card.h Card module header file. */
...
/** @def CARD_NAME_MAX_SIZE Maximum size of the card name */
#define CARD_NAME_MAX_SIZE	12
...
extern BOOL CardEditInProgress(void);
extern void CardSetNameChar(uint8_t pos, char c);
extern void CardSaveName(void);
