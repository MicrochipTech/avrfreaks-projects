/*
         ...
         Fixed joystick routine to initialize only those pins of PORTE that are used.
...
// define globals for tone generation
static volatile uint8_t	 ToneVol		= 80;
static volatile uint8_t ToneDuration	= 0;	//in 64ths of a second (LCD frame rate)
