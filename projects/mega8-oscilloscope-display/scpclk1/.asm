...
;	
; TLC7528 generates output signals for input channels 
; of an analog oscilloscope in XY mode
;
; 1(mega8) ------  x				15(mega8) ------  x
; 2(mega8) ------  14(TLC7528)			16(mega8) ------  x
; 3(mega8) ------  13(TLC7528)			17(mega8) ------  x
; 4(mega8) ------  12(TLC7528)			18(mega8) ------  x
; 5(mega8) ------  11(TLC7528)			19(mega8) ------  x
; 6(mega8) ------  10(TLC7528)			20(mega8) ------  +5
; 7(mega8) ------  +5				21(mega8) ------  x
; 8(mega8) ------  GND				22(mega8) ------  GND
; 9(mega8) ------  XTAL				23(mega8) ------  6(TLC7528)
; 10(mega8) ------ XTAL				24(mega8) ------  16(TLC7528)
; 11(mega8) ------ 9(TLC7528)			25(mega8) ------  x
; 12(mega8) ------ 8(TLC7528)			26(mega8) ------  x
; 13(mega8) ------ 7(TLC7528)			27(mega8) ------  x
; 14(mega8) ------ x				28(mega8) ------  x
;----------------------------------------------------------------------------------
; 1,5,15(TLC7528)  ------ GND
; 2,17,20(TLC7528) ------ +5
; 4(TLC7528)  ----------- OUT1
...
;----------------------------------------------------------------------------
        ...
        LOOP_2:
                ...
                OUT     PORTD,R16
                CBI     PORTC,PC0         ; select DACA
                CBI     PORTC,PC1         ; WR_BAR
                SBI     PORTC,PC1
                OUT     PORTD,R20
                SBI     PORTC,PC0         ; select DACB
                CBI     PORTC,PC1         ; WR_BAR
                SBI     PORTC,PC1
...
;----------------------------------------------------------------------------
        ...
        CODE_TABLE:                                  
                ...
                .DB      95, 96, 97, 98, 99,100,101,102
                .DB      103,104,105,106,107,108,109,110
                .DB      111,112,113,114,115,116,117,118
                .DB      119,120,121,122,123,124,125,126
                .DB      127,128,129,130,131,132,133,134
                ...
                .DB      0,  0,  0,  0,  0,  0,  0,  0
                .DB      0,  0,  0,  0,  0,  0,  0,  0
                .DB      143,144,145,146,147,148,149,150
                .DB      151,152,153,154,155,156,157,158
                .DB      159,160,161,162,163,164,165,166
                .DB      167,168,169,170,171,172,173,  0
