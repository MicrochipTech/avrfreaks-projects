...
This program act as a mili voltmeter, the maximun input voltage:5.12 volts
  Vref = Internal(2.56v)
  Atten = R2 / ( R1 + R2 ) = 10 / ( 10 + 10 ) = 0.5
  MaxInputVoltage = Vref / Atten = 2.56 / 0.5 = 5.12v 
...
unsigned char d[4]={0x03,0x03,0x03,0x03}; // start display with "0000"
