...
Chrdata:
Data &H03 , &H9F , &H25 , &H0D , &H99 , &H49 , &H41 , &H1B , &H01 , &H09

T0isr:
' 2 milisec @ 1MHz
   Portc = Portc Or &B00111100                              'Turn off all segments
   Incr Dcnt : If Dcnt > 4 Then Dcnt = 1
   Select Case Dcnt
      Case 1
         Dispdata = N(1) : Reset Dn1
      Case 2
         Dispdata = N(2) : Reset Dn2
      Case 3
         Dispdata = N(3) : Reset Dn3
      Case 4
         Dispdata = N(4) : Reset Dn4
   End Select
Return
