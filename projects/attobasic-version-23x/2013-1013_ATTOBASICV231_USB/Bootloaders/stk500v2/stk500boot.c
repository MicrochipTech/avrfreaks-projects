...
//*++ Jul 28, 2013 <KSV> Added the following fixes from source code with last modification date of 2012-0101
...
//	#define		ENABLE_MONITOR		#uncomment to enable monitor
#endif
...
//#if defined(RAMPZ)
//	asm volatile ( "out %0, __zero_reg__" :: "I" (_SFR_IO_ADDR(EIND)) );	// set EIND to 0
//#endif
//void (*app_start)(void) = (void (*)(void))0x0000;

//	Added following by KSV on 2013-1003 to properly call the application
#if defined(RAMPZ)
    asm volatile ( "push r1" "\n\t" ::);	// Add extra byte for 3-byte address >64KB FLASH
#endif
...
//	Added following by KSV on 2013-1003
	UART_STATUS_REG &= 0xfd ;		// clear USART status register
	boot_rww_enable();			// enable application section
//	Added preceeding by KSV on 2013-1003
