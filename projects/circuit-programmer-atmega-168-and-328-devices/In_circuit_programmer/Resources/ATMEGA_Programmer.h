...
#define RBL 255												//Will be used by EEPROM programmer


signed int EEPROM;											//Will be used by EEPROM programmer		
int text_start;			
...
int store[70];												//Used to store commands and address ready for the programmer
...
else {sendString("Target_not_detected"); wdt_enable(WDTO_120MS);while(1);}}\
