...
*
* This file is part of the Arduino FAT16 Library but was slightly modified
* to use it in a bootloader.
* Specifically, SPI signals are controlled directly and not via
* digital_write()
*
