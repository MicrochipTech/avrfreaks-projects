...
/* Following the advice given in http://www.technofetish.net/repos/buffaloplay/configkeys/Readme.txt
 * we don't use obdev's VID.  Instead we use USB By Example's, which is for
 ...
 */
#define USB_CFG_VENDOR_NAME     'w', 'w', 'w', '.', 's', 't', 'a', 'h', 'l', 'k', 'e', '.', 'o', 'r', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'e', 'm', 'p', 'e', 'r', 'a', 't', 'u', 'r', 'e', 'P', 'r', 'o', 'b', 'e'
