...
#define OW_WILL_USE_A_TIMER           0      /* 0=use inline delay functions, 1=use a timer. */
#define OW_USE_TIMER                  0      /* 0=use timer 0, 2=timer 2 */
...
extern void                 ow_config_io(volatile unsigned char* port, unsigned char pin);
#endif
/*
