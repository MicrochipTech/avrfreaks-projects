...
.def   d_Swa = r11		; ADDED ; high frequency delta adjustment
.def   d_Swb = r12		; ADDED ; low  frequency delta adjustment
...
;  clr    tmp                   ; CHANGE ; (tmp is cleared, but not the carry flag)
   inc    ptr_Ha                ; CHANGE ; Refresh pointer for the next sample
   add    ptr_La,d_Swa		; CHANGE ; add frequency correction delta
...
;  clr    tmp                   ; CHANGE ; (tmp is cleared, but not the carry flag)
   inc ptr_Hb                   ; CHANGE ; refresh pointer for the next sample
   add ptr_Lb,d_Swb		; CHANGE ; add frequency correction delta
...
main20:
   ...
   adc   ZH,tmp			; ADDED
   lpm				; ADDED
   mov   d_SWb,r0               ; ADDED ; this is low frequency d_SW
...
main50:                                 ; there is a zero bit in count-1  position
   ...
   adc   ZH,tmp			; ADDED
   lpm				; ADDED
   mov   d_SWa,r0               ; ADDED	; this is high frequency d_SW
