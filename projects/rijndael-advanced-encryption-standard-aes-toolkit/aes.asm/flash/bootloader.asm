...
;--------------------------------------------------------------------------------------------------
;
;	This is just some simple test code to provide a framework example on how to use aes_key_expand.
;		aes_b_encrypt and aes_b_decrypt. The data in these examples are from the FIPS PUB 197 AES
;		specification. You can use this document to test these routines.
;
...
s_ktab:
		; 256 bit cipher key
	.db 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81		; 256 bit cipher key   0-127
	.db 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4		; 256 bit cipher key 128-255
		; 192 bit cipher key
