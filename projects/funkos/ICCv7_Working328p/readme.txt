====================================
FunkOS r2: ICCV7 sample project readme:
====================================
	...
	This version of MyFirstApp is assembled as a minimal ICCv7 project for use
	...
	If you want to build a FunkOS ICCv7 project from scratch, simply copy the contents
	of the "config", "kernel", and "ports\AVR_ICC\XXX" folder from the source release 
	into an empty folder. Next, create a new project in ICC, and add all of the source files
	to the project.
	
	A project should also include a global ARCH_AVR define flag define, or a #define ARCH_AVR
