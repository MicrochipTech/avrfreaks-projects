...
extern unsigned char SetPixel(unsigned int xpos, unsigned int ypos, unsigned char mode);
extern unsigned char GetPixel(unsigned int xpos, unsigned int ypos);
extern unsigned char GetChipNumber(unsigned int xpos);
