...
;      78        if(fel_le) { 
	...
	OR   R0,R5
	BREQ _0x6
;      79           if(OCR0A<255) OCR0A++; //addig növelem amíg nem max 
	IN   R30,0x36
	CPI  R30,LOW(0xFF)
	BRSH _0x7
	IN   R30,0x36
	SUBI R30,-LOW(1)
	OUT  0x36,R30
;      80             else fel_le = !fel_le; //ha max, akkor lefelé 
	RJMP _0x8
_0x7:
	RCALL SUBOPT_0x0
;      81                 } 
...
_0x6:
	...
	OR   R0,R5
	BRNE _0x9
;      83           if(OCR0A) OCR0A--; //addig csökkentem amíg >0 
	IN   R30,0x36
	CPI  R30,0
	BREQ _0xA
	IN   R30,0x36
	SUBI R30,LOW(1)
	OUT  0x36,R30
;      84             else fel_le = !fel_le; //ha min, akkor felfelé 
	RJMP _0xB
_0xA:
	RCALL SUBOPT_0x0
;      85             }                                              
