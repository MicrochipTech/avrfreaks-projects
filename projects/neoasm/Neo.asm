...
GreenLED:		; three periods per bit: High:0.4uS  data:0.45uS  Low:0.40uS
	out	PORTB,	oneReg		;Grn7H    1 cycles       0     x
	mov	temp2,	zeroReg		;         1 cycle      .125    H
	out	PORTB,	temp		;Grn7D    1 cycle      .25     H
	nop				;         1 cycle      .375    D
	nop				;         1 cycle      .50     D
	sbrc	LEDvalueReg, 6		;       1_2 cycle      .625    D
	mov	temp2,	oneReg		;         1 cycle      .87     D
	out	PORTB ,	zeroReg		;Grn7L    1 cycle     1.00     D
	nop				;         1 cycle     1.125    L
	nop				;         1 cycle     1.25     L

	out	PORTB,	oneReg		;Grn6H    1 cycle     1.375    L
	mov	temp,	zeroReg		;         1 cycle     1.50     H
	out	PORTB,	temp2		;Grn6D    1 cycle     1.625    H
	nop				;         1 cycle     1.75     L
	nop				;         1 cycle     1.87     L
	sbrc	LEDvalueReg, 5		;       1_2 cycle     2.125    D
	mov	temp,	oneReg 		;         1 cycle     2.25     D
	out	PORTB,	zeroReg		;Grn6L    1 cycle     2.375    D
	nop				;         1 cycle     2.50     L
	nop				;         1 cycle     2.625    L

	out	PORTB,	oneReg 		;Grn5H    1 cycle     2.75     L
	mov	temp2,	zeroReg		;         1 cycle     3.0      H
	...
	out	PORTB,	temp2  		;Grn4D    1 cycle     4.50
	nop				;         1 cycle     4.625    L
	nop				;         1 cycle     4.75     L
	sbrc	LEDvalueReg, 3		;       1/2 cycle     5.0      D
	mov	temp, oneReg 		;         1 cycle     5.125    D
	out	PORTB, zeroReg		;Grn4L    1 cycle     5.25     D
	nop				;         1 cycle     5.375    L
	nop				;         1 cycle     5.50     L

	out	PORTB,oneReg 		;Grn3H    1 cycle     5.6250   L
	mov	temp2,zeroReg		;         1 cycle     5.75     H
	out	PORTB,temp		;Grn3D    1 cycle     5.8750
	nop				;         1 cycle     6.00     L
	nop				;         1 cycle     6.125    L
	sbrc	LEDvalueReg, 2		;       1/2 cycle     6.25     D
	mov	temp2,	oneReg		;         1 cycle     6.375    D
	out	PORTB,	zeroReg		;Grn3L    1 cycle     6.50     D
	nop				;         1 cycle     6.625    L
	nop				;         1 cycle     6.750    L

	out	PORTB, oneReg 		;Grn2H    1 cycle     6.8750   L
