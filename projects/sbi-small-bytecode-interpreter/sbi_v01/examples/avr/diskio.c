...
#define SELECT()	PORTB &= ~0x08	/* CS = L */
#define	DESELECT()	PORTB |=  0x08	/* CS = H */
#define	MMC_SEL		!(PORTB & 0x08)	/* CS status (true:CS == L) */
