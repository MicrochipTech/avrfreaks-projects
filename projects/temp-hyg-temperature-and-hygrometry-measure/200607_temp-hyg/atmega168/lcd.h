...
void lcdDrawBitmapWithPatternAt(uint8_t, uint8_t, uint8_t *, uint8_t, uint8_t);
#define lcdDrawBitmapAt(column, line, bitmap, bitmapSize) lcdDrawBitmapWithPatternAt(column, line, bitmap, bitmapSize, 0)
