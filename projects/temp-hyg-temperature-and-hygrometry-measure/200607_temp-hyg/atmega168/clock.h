...
#define CLOCK_WITH_LONG_YEARS 1
#define CLOCK_WITH_SHORT_YEARS 0

#define CLOCK_RECORD 509	/* Store clock (yy.mm.dd) at end of eeprom */
...
void clockGetDateAsString(char *, uint8_t);
