...
alarm2_4: .byte 1
alarm_ctrl: .byte 1
alarm_ctrl_status: .byte 1
screen_buffer: .byte 64
...
SM:
	...
	breq jump_alarm_routine
	cpi r16,0x20
	breq jump_adjust_time
SMret:
...
BCD_TO_ASCII:				; routine to convert BCD to ASCII and store in appropriate registers
	...
	sts weekbcd,r16			; copy week value to weekbcd register in sram
	inc r16
...
;day:.db 0x00,0x00,"M","O","T"."U","W","E","T","H","F","R","S","A","S","U"
...
savehour:
	...
	inc r24					; increase 1 count, 0x01 becomes 0x02, houradj becomes minute adj
	rcall ms500
