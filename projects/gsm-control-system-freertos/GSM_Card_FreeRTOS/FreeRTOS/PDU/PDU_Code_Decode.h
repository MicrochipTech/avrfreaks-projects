#ifndef PDU_CODE_DECODE_H
#define PDU_CODE_DECODE_H
...
void CharToGSM_7( unsigned char *);
void GSM_7ToChar( unsigned char *);
int htoi( unsigned char );
void itoh( int , unsigned char *);
int SMS_GSMEncode(int,char*,int,int,unsigned char*,int *);
void strtoh( int8_t *, unsigned char *, int   );
int SMS_GSMDecode( unsigned char *, unsigned char *, int );
void htostrint( unsigned char *, int );
