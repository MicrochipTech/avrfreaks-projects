...
extern void lcd_goto_rc(uint8_t r, uint8_t c);
...
/* ****************************************************************** */
extern void lcd_writestr(const char *cp, int row, int col);
...
/*************************************************************************
lcd_getxy()  return lcd address counter.
*************************************************************************/
...
/* ****************************************************************** */
extern int lcd_getrc(uint8_t get_row);
