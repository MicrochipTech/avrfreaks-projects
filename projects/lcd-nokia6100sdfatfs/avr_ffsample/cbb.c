...
#define DO			(PINB &	0x08)	/* Get MMC DO value (high:true, low:false) */

#define	INS			(!(PINB & 0x10))	/* Card is inserted (yes:true, no:false, default:true) */
#define	WP			(PINB & 0x20)	/* Card is write protected (yes:true, no:false, default:false) */
