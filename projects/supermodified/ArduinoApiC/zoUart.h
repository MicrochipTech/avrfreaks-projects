...
#define	ZO_UART_ERROR_RX_FRAME_ERROR			0x02	//Frame receive error (check host settings)
#define	ZO_UART_ERROR_RX_PARITY_ERROR			0x03	//Parity receive error (check host settings)
#define	ZO_UART_ERROR_RX_BUFFER_OVERFLOW		0x04	//Buffer overflow, user code needs to call getChar() more frequently
#define	ZO_UART_ERROR_RX_DATA_OVERRUN			0x05	//FIFO overflow, more ISR time is needed
#define	ZO_UART_ERROR_TX_TIMEOUT				0x06	//No space in Tx buffer for transmit_timeout_miliseconds
