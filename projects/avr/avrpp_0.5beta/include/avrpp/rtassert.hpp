...
#ifndef AVRPP_RTASSERT_HPP___
#define AVRPP_RTASSERT_HPP___

#ifdef AVRPP_AVR_GCC
#include <avrpp/ports/avr-gcc/rtassert.hpp>
#else
#ifdef AVRPP_KTEST
// ktest port is built for host system. Testing and debugging use ONLY.
#include <avrpp/ports/ktest/rtassert.hpp>
#else
#error "AVR++ port is not selected. Please define an appropriate macro for your platform..."
#endif
#endif

#endif //AVRPP_RTASSERT_HPP___
