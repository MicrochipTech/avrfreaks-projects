...
;* Version	: 3.4
;* Last updated	: 27/Apr/06
;* Target	: AT90S2313 @ 4Mhz (orig. AT90S1200)
;* File		: AVR910_2313_v3_4.asm
...
;*
;* HISTORY
;*  V3.4	27/Apr/06 (J.Prchal) LED indication
...
.equ	silicon_chip=0	;If 1 Mosi and Miso pinout swapped
...
.equ	SW_MINOR = '4'		; Minor SW revision number
