...
void fifo_copy(struct fifo_control *target, struct fifo_control *source);

void* fifo_read(struct fifo_control*, void* item, unsigned int size);
void* fifo_preview(struct fifo_control*, void* item, unsigned int size);
...
void fifo_init(struct fifo_control *, unsigned int size, void(*post_fptr)(void), void(*wait_fptr)(void), void* data_space);

void fifo_flush(struct fifo_control *);

char fifo_read_char(struct fifo_control *);
int  fifo_read_int(struct fifo_control *);
long fifo_read_long(struct fifo_control *);
char* fifo_read_string(struct fifo_control *, char *, int);

void fifo_write_char(struct fifo_control *, char);
void fifo_write_int(struct fifo_control *, int);
void fifo_write_long(struct fifo_control *, long);

void fifo_write_string(struct fifo_control *obj, char*string);
void fifo_write_string_P(struct fifo_control *obj, PGM_P);
