...
namespace DevInfo
{
	...
	class DeviceInfo
	{
		...
		public static string[] ParseFriendlyPorts()
		{
			...
			//System.Windows.Forms.MessageBox.Show("cArray.Length: " + cArray.Length.ToString() + "\nstrArray.Length: " + strArray.Length.ToString());
		...
		public static string GetPorts()
		{
			...
			while(true)
			{
				...
				result=EnumerateDevices(Index++, "Ports", devices);
				if(result != 0) break;
