...
/*
General Description:
USB driver configuration for HID device
*/
 ...
 * this device instead. John has offered this VID for use by students for
 * non-commercial devices. DO NOT LET DEVICES WITH THIS VID ESCAPE YOUR LAB!
 ...
 */
#define USB_CFG_VENDOR_NAME     'j', 'a', 'd', 'o', 'n', 'c', 'l', 'e', 'w', 's', '@', 'g', 'm', 'a', 'i', 'l', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'W', 'i', 'S', 'H', 'A', 'B', 'I'
 ...
 */
/*
#define USB_CFG_SERIAL_NUMBER   '0','0','0','0', 'D','E','A','D', 'B','E','E','F'
