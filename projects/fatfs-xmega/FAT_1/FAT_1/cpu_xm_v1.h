...
#define   	mmc_port_init 	PORTC_DIRSET=0X10
#define   	CS_LOW()	PORTC_OUTCLR=0X10
#define	  	CS_HIGH()	PORTC_OUTSET=0X10
...
#define   	mmc_port_init 	PORTD_DIRSET=0X10
#define   	CS_LOW()	PORTD_OUTCLR=0X10
#define	  	CS_HIGH()	PORTD_OUTSET=0X10
...
#define   	mmc_port_init 	PORTE_DIRSET=0X10
#define   	CS_LOW()	PORTE_OUTCLR=0X10
#define	  	CS_HIGH()	PORTE_OUTSET=0X10
#else
#error	Not supported
#endif
...
#define   	mmc_port_init 	PORTF_DIRSET=0X10
#define   	CS_LOW()	PORTF_OUTCLR=0X10
#define	  	CS_HIGH()	PORTF_OUTSET=0X10
#else
#error	Not supported
#endif
