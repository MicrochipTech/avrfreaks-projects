...
If R = "1" Then                                             'Rear Right Wheel
   ...
   End If
Elseif R = "2" Then                                         'Rear Right Steer
...
If W < 755 Then
   Steeringright = 1                                        'right increases
   Steeringleft = 0                                         'left decreases value of w
Elseif W > 765 Then
   Steeringright = 0                                        'Right incrases
   Steeringleft = 1                                         'left decreases value of w
End If
End If
'''''''''''''''''''''''''''''''''
'Cls
