...
TYPE IT! - A small text editor using AVR
...
This can be set on an ordinary line PCB. After wiring up and soldering the circuit, flash the AVR with hex file and set fuses matching the frequency. That's all. 
