...
C:\WinAVR\bin\avrdude.exe -p t13 -P COM1 -c ponyser -u -U calibration:r:calibration.BIN:r -U flash:w:default\ServoControl.hex -U eeprom:w:default\ServoControl.eep -U eeprom:w:0x01:m -U hfuse:w:0xFF:m -U lfuse:w:0x6A:m -U lock:w:0x3f:m 
pause