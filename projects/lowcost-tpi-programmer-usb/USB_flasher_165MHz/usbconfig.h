...
static void usbEventResetReady(void);
#endif
 ...
 */
#define USB_CFG_VENDOR_NAME     'R', 'o', 's', 'e', 'n', 'd', 'a', 'h', 'l'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'P', 'I', 'F', 'l', 'a', 's', 'h'
 ...
 */
/*
#undef USB_CFG_DMINUS_BIT
#undef USB_CFG_DPLUS_BIT
...
#define USB_INTR_VECTOR         SIG_PCINT0
*/
