...
; TIMER0
	...
	;
	ldi	r16, (1<<COM0A1) | (1<<COM0A0) | (1<<COM0B1) | (1<<WGM01)
	out	TCCR0A, r16
...
;
	in	r16, TIMSK0
	ori	r16, /*(1<<ICIE0) | (1<<OCIE0B) | (1<<OCIE0A) |*/ (1<<TOIE0)
	out	TIMSK0, r16
	ldi	r16, (1<<PSR)
	out	GTCCR, r16
;	sei
...
;
	in	r16, TIMSK0
	andi	r16, 255-( (1<<ICIE0) | (1<<OCIE0B) | (1<<OCIE0A) | (1<<TOIE0))
	out	TIMSK0, r16
;
;	sei
	pop	r16
