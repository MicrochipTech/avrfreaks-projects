...
.SET m_UseHWmul		= TRUE				; enables hardware multiplication for uc's that support it

.SET m_UseMul8 		= FALSE
.SET m_UseMul16 	= FALSE
.SET m_UseMul32 	= TRUE

.SET m_UseRound		= TRUE				; enables rounding function for division routines
