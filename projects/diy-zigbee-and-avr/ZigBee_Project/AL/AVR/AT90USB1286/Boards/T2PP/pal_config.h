 ...
 */
 // 9/12/2010  Modified to use Teensy2++ Board    -jkl
 //				No changes except name so far.
 // 9/13/2010  Changed LED0 - it's active high, not low.  -jkl
 // 9/13/2010  Modified setting of SPI clock to slow it down.   -jkl
 // 9/20/2010  Timer clock source is now same in sleep or wake.  -jkl
