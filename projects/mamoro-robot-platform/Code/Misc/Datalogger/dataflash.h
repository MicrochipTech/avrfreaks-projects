...
//*****************************************************************************
//
// Last modifed  by:	 Jidan Al-Eryani,	jidan@gmx.net
// Date:	3.4.2007 
//Modified to support Dataflashes with 2 buffers. Tested with ATmega128(L) and AT45DB041B (512K X 8)
//
//******************************************************************************
...
//Dataflash constants
#define DF_PAGE_SIZE 264 //size of dataflash page (bytes)
