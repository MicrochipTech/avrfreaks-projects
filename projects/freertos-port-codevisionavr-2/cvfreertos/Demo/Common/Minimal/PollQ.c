...
signed portCHAR temp1[]="Poll_Test_Queue";
signed portCHAR temp2[]="QConsNB";
signed portCHAR temp3[]="QProdNB";
	...
	vQueueAddToRegistry( xPolledQueue, temp1);

	/* Spawn the producer and consumer. */
	xTaskCreate( vPolledQueueConsumer, temp2, pollqSTACK_SIZE, ( void * ) &xPolledQueue, uxPriority, ( xTaskHandle * ) NULL );
	xTaskCreate( vPolledQueueProducer, temp3, pollqSTACK_SIZE, ( void * ) &xPolledQueue, uxPriority, ( xTaskHandle * ) NULL );
}
/*-----------------------------------------------------------*/
