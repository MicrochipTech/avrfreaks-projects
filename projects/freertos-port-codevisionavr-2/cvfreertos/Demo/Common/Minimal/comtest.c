...
{
    signed portCHAR temp1[]="COMTx";
    signed portCHAR temp2[]="COMRx";
	...
	xTaskCreate( vComTxTask, temp1, comSTACK_SIZE, NULL, uxPriority - 1, ( xTaskHandle * ) NULL );
	xTaskCreate( vComRxTask, temp2, comSTACK_SIZE, NULL, uxPriority, ( xTaskHandle * ) NULL );
}
/*-----------------------------------------------------------*/
