...
;	Michal Strug 2005
;
;	sample communication with at90S2313 and cf card
;
...
;
;	compiled with borland c++ compiler 5.5
*/
...
#define liczba_sektorow 62720		// insert value specific to your card
...
int main( int argc, char *argv[] )
{
   ...
   printf("\n"); 
	...
	fd = fopen( "drive_info.bin", "wb" );
	TransmitCommChar( hCom, 'd' );

	int licz_di=0;
	while(1)				// reading drive info
	{
		c[0] = 0;
	...
	while(1)							// reading whole card data
	{
		...
		if( liczS >= liczba_sektorow + 1 /*drive info*/ ) break;
