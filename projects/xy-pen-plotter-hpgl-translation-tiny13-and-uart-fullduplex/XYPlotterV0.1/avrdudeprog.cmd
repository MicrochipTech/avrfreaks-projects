...
C:\WinAVR\bin\avrdude.exe -p t13 -P COM1 -c ponyser -u -U calibration:r:calibration.BIN:r -U flash:w:default\XYPlotter.hex -U eeprom:w:default\XYPlotter.eep -U hfuse:w:0xFF:m -U lfuse:w:0x6A:m -U lock:w:0x3f:m 
pause