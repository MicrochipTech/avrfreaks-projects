/**
 * \AVR32 USART2 Example
 *
 * \This project demonstrates serial communication over the USART2 on the AT32UC3C0512C chip.
 * \This project is specific to the AT32UC3C-EK development board
 * \The serial is output over the USB_VCP port.
 */
...
int main( void )
{
	...
	volatile struct avr32_usart_t *usart = &AVR32_USART2;
