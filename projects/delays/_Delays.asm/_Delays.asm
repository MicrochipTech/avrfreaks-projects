 ...
 *
 *  Created: 04/08/2012 19:35:05
 *   Author: JHuygh
 */ 

 ;******************************************************************************
;_Delays.asm Version 1.0b (replaces Version 1.0a)
;******************************************************************************
;
;Written for  : Atmel "AVR Assembler" and "AVR Assembler 2"
;        when : 2006 September 26
...
;    * a version that can be used as a subroutine taking in to account the time
...
;
;	_waste_us n
;		 With  (1000000/F_CPU) <= n <= 25769803779/Your_CPU_frequency_in_MHz
;
; 	     This macro will generate a wait loop from 1 탎 to 25769803779 탎
;            Depending on the CPU-speed set in F_CPU here below you will need to
;            respect a minimum value for n.  (n_minimum) = 1000000/F_CPU).
...
;        _waste_us is absolutely exact down to (1/Your_CPU_frequency_in_MHz) 탎
;        _waste_us will pick the smallest code for your delay (Maximum 13 words)
...
;
; D) Use the statement _waste_us n, in your code
;
;Here is a code example :
;
;	.INCLUDE "_waste.asm"	;Make the macro _waste_us n available in your code
;	_waste_us 100		;loop for       100 탎 (that's  0,1 ms)
;	_waste_us 16000   	;loop for    16.000 탎 (that's 16   ms)
;	_waste_us 7000000	;loop for 7.000.000 탎 (that's  7   s )
;

;******************************************************************************
;The CPU-speed needs to be set before you can use _waste_us.
...
;   You can simplify the next 9 lines of code before "_Cycle_waster Cycles_Needed"
