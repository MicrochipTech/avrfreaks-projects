...
*	- wait BOOT_WAIT(ms) before reading the pbutton and making the choice of either
*	  entering the program mode or normal operation.

Press the RESET button than press the boot-startup button within 2 seconds and keep pressing it for another 2 seconds to enter programming mode. 
****************************************************************************/
