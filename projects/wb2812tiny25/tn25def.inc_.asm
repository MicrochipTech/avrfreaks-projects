...
;***** Created: 2005-11-04 09:37 ******* Source: ATtiny25.xml ************
;*************************************************************************
...
;; Tiny25 interrupt table
;	reti	;INT0addr	= 0x0001	; External Interrupt 0
;	reti	;PCI0addr	= 0x0002	; Pin change Interrupt Request 0
;	reti	;OC1Aaddr	= 0x0003	; Timer/Counter1 Compare Match 1A
...
;	reti	;OC1Baddr	= 0x0009	; Timer/Counter1 Compare Match B
;	reti	;OC0Aaddr	= 0x000a	; Timer/Counter0 Compare Match A
;	reti	;OC0Baddr	= 0x000b	; Timer/Counter0 Compare Match B
;	reti	;WDTaddr	= 0x000c	; Watchdog Time-out
;	reti	;USI_STARTaddr	= 0x000d	; USI START
;	reti	;USI_OVFaddr	= 0x000e	; USI Overflow


;      Tiny25 fuse settings ::   SP12 -wF1111001
; Value    high byte            Value  low byte
;   1        7  - RSTDISBL        0    7  - Clock /8
;   1        6  - DWEN            1    6  - CLKOUT 0=clk out on pin 2
;   0        5  - SelfProgEn      1    5  - Start Up 1
;   1 (dft)  4  - WDTON	          1    4  - Start Up 0
;   1 (dft)  3  - EESAVE          1    3  - CLKsel3  0010=8MHz Int 0011=6.4MHz Int
;   1 (dft)  2  - BODlev2         0    2  - CLKsel2  0000=Ext
;   1 (dft)  1  - BODlev1         0    1  - CLKsel1  
;   1 (dft)  0  - BODlev0         1    0  - CLKsel0  
