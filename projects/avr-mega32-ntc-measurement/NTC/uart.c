...
#if (PLATFORM != SMS) //CR Flag for simulation
volatile uint8_t seen_cr = 0;
#endif
...
/*************************************************************************
Function: uart_flush()
Purpose:  initialize UART Bufferpointersand set baudrate
Input:    none
Returns:  none
**************************************************************************/
...
Returns:  none          
**************************************************************************/
void uart1_puts(const uint8_t *s )
{
    while (*s) 
      uart1_putc(*s++);
...
Returns:  none
**************************************************************************/
void uart1_puts_p(const uint8_t *progmem_s )
{
    register uint8_t c;
